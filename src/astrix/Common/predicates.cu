...
Predicates::Predicates(Device *device)
{
  ...
  //std::cout << "Predicates parameters on host: ";
  //for (int i = 0; i < 15; i++) std::cout << pParamHost[i] << " ";
  //std::cout << std::endl;
  ...
  if (device->GetDeviceCount() > 0) {
    ...
    //param->CopyFromDevice();
    //pParamHost = param->GetHostPointer();

    //std::cout << "Predicates parameters on device: ";
    //for (int i = 0; i < 15; i++) std::cout << pParamHost[i] << " ";
    //std::cout << std::endl;
...
__host__ __device__
real Predicates::incircle(real ax, real ay,
			  real bx, real by,
			  real cx, real cy,
			  real dx, real dy,
			  real *pParam)
...
__host__ __device__
real Predicates::incircleadapt(real ax, real ay,
				     real bx, real by,
				     real cx, real cy,
				     real dx, real dy,
				     real permanent,
...
/*
__host__ __device__
int Predicates::scale_expansion_zeroelim(int elen, real *e,
					 real b, real *h,
					 real *pParam)
...
/*
__host__ __device__
int Predicates::fast_expansion_sum_zeroelim(int elen, real *e, int flen,
					    real *f, real *h)
// h cannot be e or f. 
{
  real zero = 0.0;
...
real Predicates::orient2d(real ax, real ay,
			  real bx, real by,
			  real cx, real cy,
			  real *pParam)
{
...
real Predicates::orient2dadapt(real ax, real ay,
				     real bx, real by,
				     real cx, real cy,
				     real detsum, real *pParam)
{
  real zero = 0.0;
...
{
   real adx, ady, adz, bdx, bdy, bdz, cdx, cdy, cdz;
...
real incircleadapt(real ax, real ay,
		   real bx, real by,
		   real cx, real cy,
		   real dx, real dy, real permanent){
   real adx, bdx, cdx, ady, bdy, cdy;
  real det, errbound;
...
real insphereslow(real *pa, real *pb, real *pc, real *pd, real *pe)
{
  ...
  real negate, negatetail;
   real axby7, bxcy7, cxdy7, dxay7, axcy7, bxdy7;
   real bxay7, cxby7, dxcy7, axdy7, cxay7, dxby7;
...
/*
__host__ __device__
inline void Predicates::Fast_Two_Sum_Tail(real a, real b, real x, real& y)
{
  real bvirt = x - a; 
  y = b - bvirt;
}
...
__host__ __device__
inline void Predicates::Fast_Two_Sum(real a, real b, real& x, real& y)
{
  x = (real) (a + b); 
...
__host__ __device__
inline void Predicates::Fast_Two_Diff_Tail(real a, real b, real x, real& y)
{
  real bvirt = a - x; 
  y = bvirt - b;
}
...
__host__ __device__
inline void Predicates::Fast_Two_Diff(real a, real b, real& x, real& y)
{
  x = (real) (a - b); 
...
__host__ __device__
inline void Predicates::Two_Sum_Tail(real a, real b, real x, real& y)
{
  real bvirt = (real) (x - a); 
  real avirt = x - bvirt; 
  real bround = b - bvirt; 
...
__host__ __device__
inline void Predicates::Two_Sum(real a, real b, real& x, real& y)
{
  x = (real) (a + b); 
...
__host__ __device__
inline void Predicates::Two_Diff_Tail(real a, real b, real x, real& y)
{
  real bvirt = (real) (a - x); 
  real avirt = x + bvirt; 
  real bround = bvirt - b; 
...
__host__ __device__
inline void Predicates::Two_Diff(real a, real b, real& x, real& y)
{
  x = (real) (a - b); 
...
__host__ __device__
inline void Predicates::Split(real a, real& ahi, real& alo, real splitter)
{
...
__host__ __device__
inline void Predicates::Two_Product_Tail(real a, real b,
					 real x, real& y,
					 real splitter,
					 real& ahi, real& alo,
					 real& bhi, real& blo)
...
__host__ __device__
inline void Predicates::Two_Product(real a, real b,
				    real& x, real& y,
				    real splitter,
				    real& ahi, real& alo,
				    real& bhi, real& blo)
...
__host__ __device__
inline void Predicates::Two_Product_Presplit(real a, real b,
					     real bhi, real blo,
...
__host__ __device__
inline void Predicates::Two_Product_2Presplit(real a, real ahi, real alo,
...
__host__ __device__
inline void Predicates::Square_Tail(real a, real x, real& y, real splitter,
				    real& ahi, real& alo)
{
  Split(a, ahi, alo, splitter);					
  real err1 = x - (ahi * ahi); 
...
__host__ __device__
inline void Predicates::Square(real a, real& x, real& y, real splitter,
			       real& ahi, real& alo)
{
  x = (real) (a * a); 
...
__host__ __device__
inline void Predicates::Two_One_Sum(real a1, real a0, real b,
...
__host__ __device__
inline void Predicates::Two_Two_Sum(real a1, real a0, real b1, real b0,
				    real& x3, real& x2, real& x1, real& x0,
				    real& _j, real& _0, real& _i)
{
...
__host__ __device__
inline void Predicates::Two_One_Diff(real a1, real a0, real b,
				     real& x2, real& x1, real& x0, real& _i)
{
  Two_Diff(a0, b , _i, x0); 
  Two_Sum( a1, _i, x2, x1);
...
__host__ __device__
inline void Predicates::Two_Two_Diff(real a1, real a0, real b1, real b0,
				     real& x3, real& x2, real& x1, real& x0,
				     real& _i, real& _j, real& _0)
{
