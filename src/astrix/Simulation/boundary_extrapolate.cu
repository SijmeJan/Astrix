...
//######################################################################
/*! Consider all triangles in the Mesh. If a triangle has exactly one vertex on the boundary, we extrapolate the state to this vertex by using the state at the other two vertices.*/
//######################################################################
